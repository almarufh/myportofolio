const Hero = () => {
  ...
  <a href="#contact" className="border border-zinc-600 hover:border-zinc-400 text-zinc-300 hover:text-white px-6 py-3 rounded-lg font-medium transition duration-300">
    Hubungi Saya
  </a>
</div>
        </div>
        ...
        <div className="order-1 md:order-2 flex justify-center md:justify-end">
          <img 
            src="https://placehold.co/500x500/2563eb/ffffff?text=Foto+Profil" 
